...
public class NewJFrame extends javax.swing.JFrame {
  ...
  private ComboBoxModel getAircraftIds() {
    try {
      return new javax.swing.DefaultComboBoxModel( db.getAllAircraftIds() );
  ...
  private ComboBoxModel getRunwayIds() {
    try {
      return new javax.swing.DefaultComboBoxModel(db.getAllRunwayIds( getAircraftId() ));
    } catch (DatabaseException ex) {
      ex.printStackTrace();
    }
    return null;
  ...
  private String getRunwayId() {
     ...
     if(jComboBox4 != null) 
        id = (String) jComboBox4.getSelectedItem();
  ...
  @SuppressWarnings("unchecked")
    ...
    jComboBox5.setModel(new JJDefaultsComboBoxModel(jComboBox5, Field.CLASSIFICATION));
    jComboBox5.setSelectedItem(getField(Field.CLASSIFICATION)
    );
    ...
    jComboBox6.setModel(new JJDefaultsComboBoxModel(jComboBox6, Field.FREQUENCY_1));
    jComboBox6.setSelectedItem(getField(Field.FREQUENCY_1));

    jComboBox7.setModel(new JJDefaultsComboBoxModel(jComboBox7, Field.FREQUENCY_2));
    jComboBox7.setSelectedItem(getField(Field.FREQUENCY_2));
        ...
        .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                    .addComponent(jScrollPane23, javax.swing.GroupLayout.DEFAULT_SIZE, 967, Short.MAX_VALUE)
                    .addGap(18, 18, 18)
    ...
    longLatFormat.setActionCommand("\n");
